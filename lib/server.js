...
exports.run = function(config) {
    ...
    c2s.on("stanza", function(stanza, client) {
        s2s.send(stanza); // Allow for the incoming stanzas to be routed... we first route to the S2S component, which will then maybe forward to the C2SServer.. and this one may push it down to the right C2SStream
    });
